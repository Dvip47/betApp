      ...
      try {
        ...
        if (token) {
          ...
          if (res) {
            ...
            if (res.status === 200) {
              setMasterUserData(res.data.other);
            }
          }
        }
      } catch (error) {
          ...
          {masterUserData ? (
            ...
            >
              ...
              >
                ...
                >
                  {masterUserData.userName}
                </p>
              </th>
              <td className="md:px-6 px-1 py-4">{masterUserData.creditRef}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.balance}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.partnership}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.exposure}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.exposureLimit}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.availableBalance}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.refPL}</td>
              <td className="md:px-6 px-1 py-4">{masterUserData.status ? "Active":"Inactive"}</td>
