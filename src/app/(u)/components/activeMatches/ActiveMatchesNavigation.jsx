...
import { get, getEvents } from '@/app/api/exchange';
...
const ActiveMatchesNav = ({ setCurrentSport, currentSport, setCurrentEventTypeId, setLoadingStatus, setSport }) => {
  ...
  const handledOnclick = (sportName, eventType) => {
    ...
    return (
        <div className="flex flex-col mt-5 w-full ">
            ...
            <div className="flex flex-col w-full bg-[#2F352E] rounded p-1">
                ...
                >
                    {
                        events.length > 0 && events.map((modes, index) => {
                            let iconName = modes.sport_name == "Soccer" ? "Football" : modes.sport_name
                                ...
                                (
                                    ...
                                    <div
                                        ...
                                        className={`${currentSport === modes.sport_name
                                            ...
                                            : "bg_1"
                                            } flex items-center justify-center gap-1 rounded-r hover:text-white cursor-pointer px-10 py-2`}
...
export default ActiveMatchesNav