...
//             //     </p>
//             //   </th>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.creditRef}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.balance}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.partnership}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.exposure}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.exposureLimit}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.availableBalance}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.refPL}</td>
//             //   <td className="md:px-6 px-1 py-4">{adminUserData.status ? "Active":"Inactive"}</td>
...
// export default ActiveMatchesTable;
