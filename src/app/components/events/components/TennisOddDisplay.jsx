          ...
          <div className="col-span-1">
            <div className="grid grid-cols-10">
              ...
              <div className="col-span-1 text-center">
                <SportsBaseballIcon color="success" />
              </div>
              {/* ODDS */}
                      ...
                      <div
                        ...
                        onClick={() =>
                          addToBetslip(
                            game.eventD.id,
                            "Home",
                            game.event_odds.odds.to_win_match.odds[0].odds ||
                              "--",
                            game
                          )
                        }
                      ...
                      <div
                        ...
                        onClick={() =>
                          addToBetslip(
                            game.eventD.id,
                            "Away",
                            game.event_odds.odds.to_win_match.odds[1].odds ||
                              "--",
                            game
                          )
                        }
...
export default TennisOddDisplay;
